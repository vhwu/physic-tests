...
public:
    ...
    const {return x<vec.x||(x==vec.x&&y<vec.y)||(x==vec.x&&y==vec.y&&z<vec.z);}
    //
...
/*
//pointers to access Vector3's fields
typedef float(Vector3::*v3_pointer);
    static const v3_pointer pY = &Vector3::y;
    static const v3_pointer pX = &Vector3::x;
    static const v3_pointer pZ = &Vector3::z;
*/
